...
export const RED_OPAQUE = "rgba(255,68,85,0.2)";
export const GREEN_OPAQUE = "rgba(76,175,80,0.2)";
...
export const ERROR_BOX_SHADOW = "0px 3px 21px rgba(255, 181, 181, 0.4)";

export const DEFAULT_BORDER = 'solid 2px #fff';
